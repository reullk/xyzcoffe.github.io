...
<section class="form-container">
   ...
   <form action="" method="POST">
      <h3>GİRİŞ YAPIN</h3>
      <p>Kullanıcı Adı  = <span>admin</span> & şifre = <span>111</span></p>
      <input type="text" name="name" maxlength="20" required placeholder="Kullanıcı adı girin" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="pass" maxlength="20" required placeholder="Şifre Girin" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
