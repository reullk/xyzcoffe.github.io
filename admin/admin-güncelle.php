...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="old_pass" maxlength="20" placeholder="eski şifrenizi girin" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="new_pass" maxlength="20" placeholder="yeni şifrenizi girin" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="confirm_pass" maxlength="20" placeholder="yeni şifrenizi onaylayın" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
