...
<br>    <br>    
  <center> <h1 class="title">Menu</h1></center>
   <br><br>
   ...
   <div class="box-container">
      ...
      ?>
      <form action="" method="post" class="box" style="border:2px solid orange; border-radius:20px;">
         <input type="hidden" name="pid" value="<?= $fetch_products['id']; ?>">
         <input type="hidden" name="name" value="<?= $fetch_products['name']; ?>">
         <input type="hidden" name="price" value="<?= $fetch_products['price']; ?>">
         <input type="hidden" name="image" value="<?= $fetch_products['image']; ?>">
         
         <button type="submit" class="fas fa-shopping-cart" name="add_to_cart" style="background: none;"></button>
         <img src="uploaded_img/<?= $fetch_products['image']; ?>" alt="">
         <a href="category.php?category=<?= $fetch_products['category']; ?>" class="cat"><?= $fetch_products['category']; ?></a>
         <div class="name"><?= $fetch_products['name']; ?></div>
         <div class="flex">
            <div class="price"><span>$</span><?= $fetch_products['price']; ?></div>
            <input type="number" name="qty" class="qty" min="1" max="99" value="1" maxlength="2" style="background: white; color: black;">
         </div>
      </form>
      <?php
            }
         }else{
            echo '<p class="empty">Menü Yok Menü ekleyin</p>';
         }
      ?>
